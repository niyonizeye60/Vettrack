// GADM 4.1 official administrative names for Rwanda: 30 districts, 417 sectors.
// Generated by scripts/sync-rwanda-data.mjs - matches lib/rwanda-coordinates.ts 1:1.
...
export const rwandaData: Record<string, string[]> = {
  ...
  "Huye": ["Gishamvu", "Huye", "Karama", "Kigoma", "Kinazi", "Maraba", "Mbazi", "Mukura", "Ngoma", "Rudashya", "Ruhashya", "Rusatira", "Rwaniro", "Simbi", "Tumba"],
