...
export const sendContactNotificationEmail = async (contactData) => {
  try {
    ...
    const info = await transporter.sendMail({
      ...
      html: emailContent,
      text: `
New Contact Form Message - NTDM Animal Hospital
...
export const sendConsultationRequestEmail = async (vetEmail, vetName, consultationData) => {
  try {
    ...
    const info = await transporter.sendMail({
      ...
      html: emailContent,
      text: `
New Consultation Request - NTDM Animal Hospital
...
export const sendNewMessageAlertEmail = async (recipientEmail, recipientName, senderName, messagePreview, conversationUrl) => {
  try {
    ...
    const emailContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
        ...
        <div style="padding: 30px; background: #f9f9f9;">
          ...
          <p style="color: #333;"><strong>${senderName}</strong> has sent you a message on NTDM Animal Hospital.</p>
    ...
    const info = await transporter.sendMail({
      ...
      html: emailContent,
      text: `
New Message - NTDM Animal Hospital

Hello ${recipientName},

${senderName} has sent you a message on NTDM Animal Hospital.
