...
interface ReportData {
  ...
  expenses: { inseminationCosts: number; veterinaryHealth: number; labourWages: number; livestockPurchases: number; feedWaterCosts: number; total: number }
  netResult: number
...
export default function GeneralReportPage() {
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      doc.text("Farm General Report", 42, 15)
      doc.setFontSize(9)
      doc.setFont("helvetica", "normal")
      doc.text(`Period: ${report.range.startDate} to ${report.range.endDate}`, 42, 23)
