...
// The page body lives in components/livestock/insemination-manager.tsx so the exact
// same UI can be rendered for a veterinarian the farmer has delegated access to
...
export default function InseminationPage() {
  ...
  return <InseminationManager farmerId={farmerId} can={ownerCapabilities(farmerId, farmerName)} />
}
