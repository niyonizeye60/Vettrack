...
// The page body lives in components/livestock/vaccination-manager.tsx so the exact
...
export default function VaccinationPage() {
  ...
  return <VaccinationManager farmerId={farmerId} can={ownerCapabilities(farmerId, farmerName)} />
}
