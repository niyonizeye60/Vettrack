...
export default function InseminationManager({ farmerId, can, showHeader = true }: InseminationManagerProps) {
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      doc.text(exportAnimalName ? `${t('farmer.inseminationReportTitle')} — ${exportAnimalName}` : t('farmer.inseminationReportTitle'), 55, 18)
      ...
      for (let page = 1; page <= totalPages; page++) {
        ...
        doc.text(`NTDM Animal Hospital | Generated by: ${can.currentUserName || "Unknown"}`, 15, pageHeight - 7)
